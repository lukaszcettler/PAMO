...
class QuizActivity : AppCompatActivity() {
    ...
    private val quiz = arrayOf(
            Quiz(R.string.quiz_question_1, false),
            Quiz(R.string.quiz_question_2, true),
            Quiz(R.string.quiz_question_3, true),
            Quiz(R.string.quiz_question_4, true),
            Quiz(R.string.quiz_question_5, false),
            Quiz(R.string.quiz_question_6, true))
